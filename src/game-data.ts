...
export function mountSlots(mountType: string): string[] {
  switch (mountType) {
    ...
    case 'Flex': return ['Flex']  // special handling in UI
    default: return [mountType]
  }
}
...
export const MECH_STATUSES = [
  'Bolstered', 'Braced', 'Downlocked', 'Exposed', 'Hidden',
  'Invisible', 'Jammed', 'Lock On', 'Prone', 'Shredded',
  'Slow', 'Stunned',
] as const

export const PILOT_STATUSES = [
  'Bleeding Out', 'Down and Out', 'Stunned',
] as const
...
export const DEFAULT_CHARACTER: Character = {
  ...
  pilot: {
    ll: 0,
    hull: 0, agility: 0, systems: 0, engineering: 0,
    armor: 0,
    skills: [],
    talents: [],
  },
